...
st.set_page_config(
    ...
    menu_items={
        ...
        'About': """
        # Space Intelligence Platform - All-in-One
        Comprehensive AI-powered space mission control and analytics system.
...
def main():
    ...
    <div style="text-align: center; padding: 2rem 0; margin-bottom: 2rem;">
        ...
        <p style="margin: 1rem 0 0 0; color: #B0BEC5; font-size: 1.2rem;">All-in-One Mission Control • AI • Mining • Simulation Center</p>
    </div>
...
def show_command_center():
    ...
    with col1:
        ...
        st.plotly_chart(earth_fig, use_container_width=True)
        
        # Real-time Space Weather
        st.markdown("#### 🌟 **Live Space Weather**")
        
        weather_data = generate_space_weather_data()
...
def show_yolo_detection():
    ...
    with col1:
        # 3D Solar System with Detection Visualization
        st.markdown("#### ☀️ **Real-time Solar Flare Detection**")
        
        # Create 3D sun with flare activity
        ...
        fig_sun.update_layout(
            title="YOLO Solar Flare Detection - Live Feed",
            scene=dict(
...
def show_asteroid_mining():
    ...
    with col1:
        ...
        # Asteroid values (profit potential)
    ...
    with col2:
        ...
        st.markdown("---")
        st.markdown("#### 💎 **Resource Prices**")
        
        resources = [
            {"name": "Platinum", "price": 28547, "change": +5.7},
            {"name": "Gold", "price": 58392, "change": -2.1},
            {"name": "Rare Metals", "price": 125847, "change": +12.4},
            {"name": "Water Ice", "price": 1247, "change": +3.2},
            {"name": "Silicon", "price": 8547, "change": -0.8}
        ]
        ...
        for resource in resources:
            ...
            <div style="background: rgba(255,255,255,0.1); padding: 0.8rem; border-radius: 8px; margin: 0.3rem 0;">
                ...
                <div style="font-size: 1.1em; color: #FFD700;">${resource['price']:,}/kg</div>
            </div>
            """, unsafe_allow_html=True)
